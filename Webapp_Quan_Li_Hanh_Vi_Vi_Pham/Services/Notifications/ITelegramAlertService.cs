...
public interface ITelegramAlertService
{
    ...
    Task<IReadOnlyCollection<TelegramSendResult>> SendViolationAlertAsync(ViolationRecord violation, string message, CancellationToken cancellationToken = default);
    ...
    IReadOnlyCollection<string> GetTargetChatIds();
}
